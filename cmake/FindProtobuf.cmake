...
if (Protobuf_INCLUDE_DIR AND EXISTS "${Protobuf_INCLUDE_DIR}/google/protobuf/stubs/common.h")
    ...
    file(STRINGS "${Protobuf_INCLUDE_DIR}/google/protobuf/stubs/common.h" _Protobuf_VERSION_STRING REGEX "${_Protobuf_VERSION_REGEX}")
    if(_Protobuf_VERSION_STRING MATCHES ${_Protobuf_VERSION_REGEX})
        set(_Protobuf_VERSION_STRING "${CMAKE_MATCH_1}")
